 ...
 *
 * @param reader The reader that would read chars from the input.
 ...
 */
export function createRule<S = any, C = any>(reader: Reader<C>, stages?: S[], nextStage?: StageProvider<S, C> | S): Rule<S, C> {
  return {reader, stages, nextStage};
}
