import { char, compileTokenizerModule, imported } from '../main';
...
describe('compileTokenizerModule', () => {
  ...
  test('compiles imported reader that is a default export', () => {
    ...
    expect(src).toBe('import{createTokenizerForRuleIterator}from"tokenizer-dsl";import _4 from"./foo";export default createTokenizerForRuleIterator(function(){var _5="TYPE_A";return function(_0,_1,_2,_3){var _6=_0.chunk,_7=_0.offset,_8=false,_9,_10=_7,_11=_6.length;while(_10<_11){var _12;_12=_4(_6,_10,_2);if(_12>_10){if(_8){_1(_9,_6,_7,_10-_7,_2,_0);_8=false}_0.offset=_7=_10;_8=true;_9=_5;_10=_12;continue}break}if(_3)return;if(_8){_1(_9,_6,_7,_10-_7,_2,_0);}_0.offset=_10;}}());');
  });

  test('compiles imported reader that is a named export', () => {
    const src = compileTokenizerModule([
      { type: 'TYPE_A', reader: imported('./foo', 'Foo') },
    ]);

    expect(src).toBe('import{createTokenizerForRuleIterator}from"tokenizer-dsl";import {Foo as _4} from"./foo";export default createTokenizerForRuleIterator(function(){var _5="TYPE_A";return function(_0,_1,_2,_3){var _6=_0.chunk,_7=_0.offset,_8=false,_9,_10=_7,_11=_6.length;while(_10<_11){var _12;_12=_4(_6,_10,_2);if(_12>_10){if(_8){_1(_9,_6,_7,_10-_7,_2,_0);_8=false}_0.offset=_7=_10;_8=true;_9=_5;_10=_12;continue}break}if(_3)return;if(_8){_1(_9,_6,_7,_10-_7,_2,_0);}_0.offset=_10;}}());');
  });

  test('compiles imported target stage', () => {
    const src = compileTokenizerModule([
      { type: 'TYPE_A', reader: char(['a']), to: imported('./foo') },
    ]);

    expect(src).toBe('import{createTokenizerForRuleIterator}from"tokenizer-dsl";import _4 from"./foo";export default createTokenizerForRuleIterator(function(){var _5="TYPE_A";return function(_0,_1,_2,_3){var _6=_0.chunk,_7=_0.offset,_8=false,_9,_10=_7,_11=_6.length;while(_10<_11){var _12;var _13;_12=_10<_6.length&&(_13=_6.charCodeAt(_10),_13===97)?_10+1:-1;if(_12>_10){if(_8){_1(_9,_6,_7,_10-_7,_2,_0);_8=false}_0.offset=_7=_10;_8=true;_9=_5;_14=_4(_6,_10,_12-_10,_2,_0);_10=_12;continue}break}if(_3)return;if(_8){_1(_9,_6,_7,_10-_7,_2,_0);}_0.offset=_10;}}());');
  });
